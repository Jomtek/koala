...
namespace Blink_Obfuscator_1._0.Protections
{
	...
	{
		// Token: 0x060000D6 RID: 214 RVA: 0x0000F610 File Offset: 0x0000D810
		public static string Random(int length)
		{
			return new string((from s in Enumerable.Repeat<string>("qwertyuiopasdfghjklzxcqwertyuiopasdfghjklzxcvbnmqwertyuiopasdfghjklzxcvbnmqwertyuiopasdfghjklzxcvbnmvbnm", length)
			select s[Renamer.random.Next(s.Length)]).ToArray<char>());
		}

		// Token: 0x060000D7 RID: 215 RVA: 0x0000F65C File Offset: 0x0000D85C
		...
		// Token: 0x060000D8 RID: 216 RVA: 0x0000F73C File Offset: 0x0000D93C
		...
		// Token: 0x060000D9 RID: 217 RVA: 0x0000F760 File Offset: 0x0000D960
		...
		// Token: 0x060000DA RID: 218 RVA: 0x0000F7B4 File Offset: 0x0000D9B4
		...
		// Token: 0x060000DB RID: 219 RVA: 0x0000F838 File Offset: 0x0000DA38
		...
		// Token: 0x060000DC RID: 220 RVA: 0x00012B44 File Offset: 0x00010D44
		public static void Execute(ModuleDef md)
		{
			foreach (TypeDef typeDef in md.Types)
			{
				...
				{
					bool flag2 = Renamer.CanRename(eventDef);
					if (flag2)
					{
				...
				{
					bool flag3 = Renamer.CanRename(methodDef);
					if (flag3)
					{
		...
		// Token: 0x060000DE RID: 222 RVA: 0x00012E6C File Offset: 0x0001106C
