...
namespace Blink_Obfuscator_1._0.Protections
{
	...
	internal class Anti_Http_Debugger
	{
		// Token: 0x06000051 RID: 81 RVA: 0x00005948 File Offset: 0x00003B48
		public static void Execute(ModuleDef module)
		{
			ModuleDefMD moduleDefMD = ModuleDefMD.Load(typeof(HTTPDebugger).Module);
			MethodDef methodDef = module.GlobalType.FindOrCreateStaticConstructor();
			TypeDef typeDef = moduleDefMD.ResolveTypeDef(MDToken.ToRID(typeof(HTTPDebugger).MetadataToken));
